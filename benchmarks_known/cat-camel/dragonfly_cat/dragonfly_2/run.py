...
budget = 347  # cat-camel 0.79 feasible (347/441)
num_opts = 21
num_dims = 2
repeats = 20
random_seed = None
...
def surface(x):
    # NOTE: returning the log of the camel surface measurements
    return np.log(surface_.run(x))
...
for num_repeat in range(missing_repeats):
    ...
    print(f'TIME TAKEN : {end_time} sec')
