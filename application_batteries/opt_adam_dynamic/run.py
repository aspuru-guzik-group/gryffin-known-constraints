...
# Config
# ------
DESC_NAMES_R1 = ['nHetero', 'MW', 'TopoPSA', 'nHeavyAtom'] #'nBondsD', # nBondsT 'apol', 'FCSP3',
DESC_NAMES_R3 = ['nHetero', 'MW', 'TopoPSA', 'nHeavyAtom', 'apol', 'FCSP3', 'Diameter', ]
DESC_NAMES_R4 = ['nHetero', 'MW', 'TopoPSA', 'nHeavyAtom', 'apol', 'FCSP3', 'Diameter',]
DESC_NAMES_R5 = ['nHetero', 'MW', 'TopoPSA', 'nHeavyAtom', 'apol', 'FCSP3', 'Diameter',]
